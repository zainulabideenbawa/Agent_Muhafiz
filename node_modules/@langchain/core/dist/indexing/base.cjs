...
const require_v5 = require("../utils/uuid/v5.cjs");
...
var _HashedDocument = class {
	...
	_hashStringToUUID(inputString) {
		return require_v5.default(this.keyEncoder(inputString), require_record_manager.UUIDV5_NAMESPACE);
	}
	_hashNestedDictToUUID(data) {
		const serialized_data = JSON.stringify(data, Object.keys(data).sort());
		return require_v5.default(this.keyEncoder(serialized_data), require_record_manager.UUIDV5_NAMESPACE);
	}
};
