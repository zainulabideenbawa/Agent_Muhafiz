...
import { InferStateType } from "./types-inference.js";
 ...
 */
type StateOf<T> = InferStateType<T> extends Record<string, unknown> ? InferStateType<T> : Record<string, unknown>;
...
//#endregion
export { AcquiredProjection, AgentServerOptions, CustomAdapterOptions, ProjectionRuntime, ProjectionSpec, RootEventBus, RootSnapshot, StateOf, StreamControllerOptions, StreamSubmitOptions, SubagentDiscoverySnapshot, SubgraphDiscoverySnapshot, Target, UseStreamCommonOptions, UseStreamOptions };
