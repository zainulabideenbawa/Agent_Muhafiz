...
var StreamProtocolMessagesHandler = class extends _langchain_core_callbacks_base.BaseCallbackHandler {
	...
	emitFinalMessage(meta, message, runId, dedupe = false) {
		...
		const toolCallId = role === "tool" && (0, _langchain_core_messages.isToolMessage)(message) ? message.tool_call_id : void 0;
		this.emit(meta, {
			event: "message-start",
	...
	handleLLMEnd(output, runId) {
		...
		const message = (0, _langchain_core_messages.isBaseMessage)(chatGeneration?.message) ? chatGeneration.message : void 0;
	...
	handleChainEnd(outputs, runId) {
		...
		const emitMessage = (value) => {
			if ((0, _langchain_core_messages.isBaseMessage)(value)) this.emitFinalMessage(meta, value, runId, true);
		};
		if ((0, _langchain_core_messages.isBaseMessage)(outputs)) emitMessage(outputs);
